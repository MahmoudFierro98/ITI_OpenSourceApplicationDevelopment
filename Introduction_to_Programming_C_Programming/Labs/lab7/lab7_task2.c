...

{
	...
	int flag = 1;
	char ch;
	struct Student student[STUDENTS_NUM];
    ...
    while (flag)
    {
		...
		else if (ch == 13)
		{
			...
			if (input == ADD_ROW)
			{
				if (studentsNumber >= STUDENTS_NUM)
				{
					printf("You can not add more students\n");
				...
				{
					student[studentsNumber] = fill_Student();
					system("cls");
					menu();
					input = ADD_ROW;
					studentsNumber += 1;
